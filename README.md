...
Pour plus d'information sur la configuration de la ressource, cliquer [ici](https://docs.openshift.com/container-platform/4.5/logging/cluster-logging-deploying.html)
